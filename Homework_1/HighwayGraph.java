...
public class HighwayGraph
{
    ...
    public static void main(String args[]) throws IOException {
        ...
        int d = g.degree(14);
        System.out.println("Vertex " + g.vertices[14].label + " has a degree of " + d);
        
        int largest = 0;
        for (int i = 1; i < g.vertices.length; i++)
        {
            if (g.degree(largest) < g.degree(i))
            {
                largest = i;
            }
        }
        
        System.out.println("Vertex " + g.vertices[largest].label + " has a degree of " + g.degree(largest));

        // ADD YOUR SOLUTION CODE FOR THE SEARCH ALGORITHMS HERE
    }
}
